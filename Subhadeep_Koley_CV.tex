...
\begin{itemize}
  ...
  \item \textbf{[Poster title]}. Poster presentation, \textit{Northeast Robotics Colloquium (NERC)},
...
\begin{itemize}
  ...
  \item Optimizing cross-entropy-method-based model predictive control for sample-efficient planning on
        real quadrotors (May 2025 -- present).
  \item Won first place at Defend the Republic 2024 against teams including Georgia Tech, UMich and ASU;
...
\section{Awards}
\begin{itemize}
  \item First place, Defend the Republic drone competition, Indiana University \hfill Nov 2024
